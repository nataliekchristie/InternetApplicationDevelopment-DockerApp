...
import { createListing, updateDescription } from './redux/actions/listingActions';
import './App.css';
    ...
    <div className="container">
     ...
     {/* THIS IS AN EXAMPLE LISTING TO FORMATTING CSS */}
      ...
      <form>
        ...
        <div><button className="makeListingSubmit" id="submit" onClick={submitListing}>GO!</button></div>
      </form>
      </div>
        </div>
      </div>
